...
def train_l2():
    """Train L2 MinAttLSTM model with 5-fold cross-validation."""
    
    print("=" * 50)
    print("L2 Training: Second-level Deep MinAttLSTM")
    print("=" * 50)
    
    X_resampled = pd.read_csv('data/X_resampled_second_level.csv', low_memory=False)
    y_resampled = pd.read_csv('data/y_resampled_second_level.csv', header=None, low_memory=False).squeeze("columns")
    ...
    print("\n" + "="*50)
    print("Overall L2 Results (5-fold CV):")
    print("="*50)
